...
const DateRangePicker = (props: DateRangePickerProps) => {
    ...
    return (
        <Flex gap="small" align="center">
            <DatePicker format={dateFormat} placeholder="DD/MM/YYYY"
                        value={startDate}
            ...
            <DatePicker onChange={onChangeEndDate} defaultValue={props.endDate && dayjs(props.endDate)} value={endDate}
                        format={dateFormat} placeholder="DD/MM/YYYY" suffixIcon={<IconCalendarDays/>}/>
        </Flex>
    );
};
