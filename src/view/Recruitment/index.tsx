...
import {IconBriefcase, IconIdCard, IconSearch, IconSetting} from "@assets/icons";
                                ...
                                jobPostings.map((job, index) => (
                                    <Col key={"job-" + index} xs={24} sm={12} lg={12} xl={12} xxl={8}>
                                        <div className="card">
                                            ...
                                            <Button type="primary"><Link to="/tuyen-dung/chi-tiet"
                                                                         style={{width: '100%', height: '100%'}}>Xem chi
                                                tiết</Link></Button>
                                        </div>
                                    </Col>
                                ))
