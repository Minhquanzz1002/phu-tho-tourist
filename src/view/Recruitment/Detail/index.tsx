...
const RecruitmentDetail = () => {
    return (
        <section className="w-full" id="recruitmentDetailSection">
            <Flex vertical gap="3.2rem">
                <Flex justify="space-between">
                    ...
                    <div>
                        <Flex justify="center" align="center" className="recruitment-status recruitment-status--open">
                            Đang tuyển
                        </Flex>
                    </div>
                </Flex>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <ul>
                                <li>Thiết kế hình ảnh, brochure, banner, poster, pano, backdrop sân khấu, các loại vé
                                    mời …
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <ul>
                                ...
                                <li>Hoặc nộp hồ sơ trực tiếp tại Trụ sở Văn phòng Công ty: 15 đường số 2, cư xá Lữ Gia,
                                    P.
